...
import { useLangueStore } from '../Components/stores/Localization';
import WithBackgroundImage from '../Components/web/pageElement/testimonials/WithBackgroundImage.vue'
import WithOverlappingImage from '../Components/web/pageElement/testimonials/WithOverlappingImage.vue'
import AboutAsWithCards from '../Components/web/pageElement/header/WithCards.vue'
...
<template>
    <Head title="Home" />
    <main class="relative w-full pt-10 dark:bg-slate-800">
